...
class UpadteProject extends Component {
                        ...
                        <div className="row">
                            <div className="col-md-8 m-auto">
                                ...
                                <form onSubmit={this.onSubmit}>
                                    ...
                                    <div className="form-group">
                                        <input type="text" className="form-control form-control-lg" placeholder="Unique Project ID" name="projectIdentifier" value={this.state.projectIdentifier} disabled onChange={this.onChange}/>
                                    </div>
...
export default connect(mapStateToProps, { getProject, createProject }) (UpadteProject);